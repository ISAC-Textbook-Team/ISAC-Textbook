...
\section[Prerequisite Knowledge: Digital Communication and Radar Sensing]{Review of Prerequisite Knowledge: Digital Communication and Radar Sensing}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/chapter1/fig_comm_system_block_diagram.png}
...
\topichead{Basic Signal Model of a Communication System}
...
This form is widely used in MIMO,
OFDM,
...
\topichead{Basic Signal Model of an ISAC System}
...
The previous discussion established basic signal models from the perspectives of both communication systems
and ISAC systems.
In an ISAC system,
...
The wireless channel is therefore not an ideal,
stable,
...
\topichead{Classification of Communication Quality Metrics}
...
\topichead{Channel State Information: Definition, Acquisition, and Role}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.86\textwidth]{figures/chapter1/fig_mimo_ofdm_flow.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{figures/chapter1/fig_mimo_gain.png}
...
This subsection does not provide a complete derivation of radar theory.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/chapter1/fig_range_estimation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/chapter1/fig_velocity_estimation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/chapter1/fig_angle_estimation.jpeg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.76\textwidth]{figures/chapter1/fig_np_estimation.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/chapter1/fig_pulse_radar.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/chapter1/fig_cw_radar.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/chapter1/fig_fmcw_chirp_sequence.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.76\textwidth]{figures/chapter1/fig_fmcw_beat_frequency.png}
